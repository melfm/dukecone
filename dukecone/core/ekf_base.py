...
class EKF():
    ...
    def __init__(self, mu, mf, dt):
        ...
        r = [1e-2, 1e-2, 0.5]          # Motion model noise
        self.R = np.diag(r)
        ...
        self.range_threshold = 10 #0.4
        self.bearing_threshold = 100#0.5
    ...
    def disable_meas_threshold(self):
        self.enabled_threshold = False
